...
namespace RepositorioGitHub.App.Controllers
{
    public class HomeController : Controller
    {
		...
		{			
			...
			if (model.IsValid)
			{
				TempData["success"] = "Repositórios encontrados com sucesso.";
			}
			else
			{
				TempData["warning"] = "Ocorreu um erro ao buscar os repositórios.";
			}
		...
		public ActionResult GetRepositorie(ActionResult<RepositoryViewModel> view)
		{
			...
			if (model.Result?.IsValid == true)
			{
				TempData["success"] = model.Result.Message;
			}
			else
			{
				TempData["warning"] = model.Result?.Message ?? "Erro desconhecido.";
			}
        ...
        [HttpGet]
        public ActionResult FavoriteSave(string owner, string name, string language, string lastUpdat, string description, string url)
        {     
            ActionResult< FavoriteViewModel> model = new ActionResult<FavoriteViewModel>();
            ...
            {                
                ...
                { 
                    ...
                    Language = language,
                    Owner = owner,
					LastUpdate =  DateTime.Parse(lastUpdat),
                    Name = name,                   
                };
